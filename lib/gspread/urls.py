...
SPREADSHEET_VALUES_URL = f'{SPREADSHEETS_API_V4_BASE_URL}/%s/values/%s'
...
SPREADSHEET_VALUES_CLEAR_URL = f'{SPREADSHEET_VALUES_URL}:clear'
...
WORKSHEET_DRIVE_URL = f'{SPREADSHEET_URL}#gid=%s'
